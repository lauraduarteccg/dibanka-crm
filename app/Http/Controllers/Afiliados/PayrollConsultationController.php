...
use App\Models\Afiliados\PayrollConsultation;
use App\Http\Resources\Afiliados\PayrollConsultationResource;
use Illuminate\Http\Request;
use Illuminate\Http\Response;
use App\Http\Requests\Afiliados\PayrollConsultationRequest;
...
class PayrollConsultationController extends Controller
{
    ...
    */
    ...
    {
        $payrolls_consultations = PayrollConsultation::with('payrolls', 'consultations')->paginate(10);
    ...
    */
    ...
    {
        $payrolls_consultations = PayrollConsultation::with('payroll', 'consultations_afiliados')->all();
    ...
    */
    public function store(PayrollConsultationRequest $request)
    {
        ...
        $pivote->load(['payroll', 'consultations_afiliados']);
