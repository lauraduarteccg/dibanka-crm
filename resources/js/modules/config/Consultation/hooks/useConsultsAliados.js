...
import {
  ...
  deleteConsult,
  getActivePayrolls,
} from "@modules/config/Consultation/services/consultationsAliadosService";

export const useConsultsAliados = () => {
  ...
  /* ===========================================================
   *  Obtener lista de consultas de aliados
   * =========================================================== */
  const fetchConsultation = useCallback(async (page = 1, search = "") => {
    ...
    try {
      ...
      console.error(err);
      setError("Error al obtener las consultas de aliados.");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  /* ===========================================================
   *  Crear o actualizar consulta de aliados
   * =========================================================== */
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.id) {
        ...
        Swal.fire("Consulta creada", "Se ha registrado una nueva consulta de aliados.", "success");
      }
      setIsOpenADD(false);
